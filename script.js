...
// ── WHATSAPP CONFIG ── change this to your number
var WHATSAPP_NUMBER = '919892446942'; // 91 = India code + number (no + or spaces)
...
function submitForm() {
  ...
  var ln = document.querySelectorAll('#enquiryModal input[type="text"]')[1].value.trim();
  var mob = document.querySelector('#enquiryModal input[type="tel"]').value.trim();
  var email = document.querySelector('#enquiryModal input[type="email"]').value.trim();
  ...
  if (!mob) { alert('Please enter your mobile number.'); return; }
  if (!course) { alert('Please select a course.'); return; }

  // Build WhatsApp message
  var text =
    '🎓 *New Enquiry – TechBricks*\n' +
    '━━━━━━━━━━━━━━━━━━━━\n' +
    '👤 *Name:* ' + fn + ' ' + ln + '\n' +
    '📞 *Mobile:* ' + mob + '\n' +
    '✉️ *Email:* ' + (email || 'N/A') + '\n' +
  ...
  document.querySelectorAll('#enquiryModal input[type="text"]')[1].value = '';
